...
## Creates a table with the numbers and percentages of mapped and unmapped reads per sample using RSEM log file from STAR

## Usage
### RSEM_Star_Mapping_Report.py  Rsem_output_directory/ Outputfilename
